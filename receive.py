# Receives the Alarmeringen JSON when a change happens in the collection
# It then stores this in a JSON file, which "alerts.py" uses to determine the activation of the light or buzzer
import random
import sys
